...
--
-- Class NitAppNotification as table nit_app_notification
--
CREATE TABLE "nit_app_notification" (
    ...
    "body" text,
    "goToPath" text,
    "pathQueryParams" text,
    "fromUserId" bigint,
    "isRead" boolean NOT NULL DEFAULT false
);

--
-- Class NitChatChannel as table nit_chat_channel
--
...
--
-- Class NitChatMessage as table nit_chat_message
--
...
--
-- Class NitChatParticipant as table nit_chat_participant
--
...
--
-- Class NitFcmToken as table nit_fcm_token
--
...
--
-- Class NitMedia as table nit_media
--
...
--
-- Foreign relations for "nit_chat_message" table
--
...
--
-- Foreign relations for "nit_chat_participant" table
--
...
ALTER TABLE ONLY "nit_chat_participant"
    ...
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "nit_chat_participant"
    ADD CONSTRAINT "nit_chat_participant_fk_2"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('nit_tools', '20251007040924507', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251007040924507', "timestamp" = now();
